{ pkgs, ... }:
{
  boot = {
    ...
    extraModulePackages = [ pkgs.opengigabyte ];
  };
  services.udev.extraRules = ''
    ...
    # Rebind if needed
    SUBSYSTEM=="hid", RUN+="${pkgs.writeShellScriptBin "gigabyte_mount" (builtins.readFile ../../src/scripts/gigabyte_mount)} $env{GIGABYTE_DRIVER} $kernel"
